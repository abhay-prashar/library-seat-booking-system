...
import { BookOpen, Grid3X3, CalendarDays, LogOut, Wifi, WifiOff, IndianRupee } from 'lucide-react';
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <aside className="sidebar">
        ...
        <div style={{ padding: '1rem', borderTop: '1px solid var(--border)' }}>
          {/* Socket status */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.75rem', fontSize: '0.72rem', color: connected ? 'var(--accent-green)' : 'var(--text-secondary)' }}>
            {connected ? <Wifi size={13} /> : <WifiOff size={13} />}
            {connected ? 'Live updates on' : 'Connecting...'}
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.75rem' }}>
            <div style={{ width: 34, height: 34, borderRadius: '50%', background: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.85rem', color: 'white', flexShrink: 0 }}>
